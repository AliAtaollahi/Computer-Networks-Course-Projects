...
int main() 
{
    ...
    srand(time(NULL));
    TCP_New_Reno_Simulator tnrs = TCP_New_Reno_Simulator();
    tnrs.simulate(200, 0.9, "result1.txt");
    tnrs.simulate(200, 0.3, "result2.txt");
    tnrs.simulate(200, 0.5, "result3.txt");
    tnrs.simulate(200, 0.7, "result4.txt");
